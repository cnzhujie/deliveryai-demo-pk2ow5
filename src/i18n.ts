  ...
  zh: {
    translation: {
      common: {
        ...
        aria_console: '演示控制台',
        aria_lang: '切换语言',
        aria_theme_light: '切换主题（当前日间）',
        aria_theme_dark: '切换主题（当前夜间）',
        aria_theme_auto: '切换主题（当前跟随系统）',
        aria_close: '关闭',
        aria_reduce: '减少',
        aria_increase: '增加',
  ...
  en: {
    translation: {
      common: {
        ...
        aria_theme_light: 'Switch theme (Light)',
        aria_theme_dark: 'Switch theme (Dark)',
        aria_theme_auto: 'Switch theme (Auto)',
        aria_close: 'Close',
      ...
      message: {
        ...
        theme_auto: 'Switched to Auto mode',
      },
    },
  },
} as const
